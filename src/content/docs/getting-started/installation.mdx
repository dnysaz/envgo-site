...
The simplest way is the PowerShell installer script — it verifies the checksum, installs the binary, and adds itself to your user `PATH` automatically:

```powershell
powershell -NoProfile -File .\Install_envGo.ps1
```
...
# Add to your user PATH (no admin rights needed)
[Environment]::SetEnvironmentVariable(
  "Path",
  [Environment]::GetEnvironmentVariable("Path", "User") + ";C:\envgo",
  "User"
)
$env:Path = "$env:USERPROFILE\C:\envgo;$env:Path"
```
