...
Download or copy the binary and put it on your `PATH`:
...
For an ARM64 Windows machine use `envgo-windows-arm64.exe`.
...
1. Extract `envGo-macOS-AppleSilicon.zip` (M-series) or `envGo-macOS-Intel.zip`
